...
const CreateGroupChatModal = ({ setShowModal, setLoading }) => {
  ...
  return (
    ...
    >
      ...
      <button
        className={`mt-auto p-1 bg-cyan-400 hover:bg-cyan-500 dark:bg-purple-500 dark:hover:bg-purple-600 text-white rounded transition-colors hover:bg-cyan-500`}
        onClick={async () => {
          setLoading(true);
